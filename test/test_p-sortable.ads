...
with Asgc.Ordered.Sortable.Dlist.Dynamic_Managed;
with Asgc.Ordered.Sortable.Dlist.Fixed_Managed;
with Asgc.Ordered.Sortable.Dlist.Expandable_Managed;
with Asgc.Ordered.Sortable.Alist.Fixed_Managed;
with Asgc.Ordered.Sortable.Alist.Expandable_Managed;
with Asgc.Ordered.Sortable.Vector.Expandable_Managed;
with Asgc.Ordered.Sortable.Vector.Fixed_Managed;
with Asgc.Ordered.Sortable.Bubble_Sort;
with Asgc.Ordered.Sortable.Quicksort;
with Ada.Unchecked_Deallocation;

package Test_P.Sortable is

   package Test1_Ord is new Test1_Con.Ordered;

   package Test1_Sort is new Test1_Ord.Sortable;

   package Bubble is new Test1_Sort.Bubble_Sort;
   package Quick is new Test1_Sort.Quicksort;

   package Test1_Vec is new Test1_Sort.Vector;
   ...
   package Test1_Dlist is new Test1_Sort.Dlist;
   ...
   package Test1_Alist is new Test1_Sort.Alist;
