...
with Test_P.Graph.Graph; use type Test_P.Graph.Test1_Graph.Object;

procedure Test_Graph is
   package Tgp1 renames Test_P.Test1_Con;
   package Tgp1_Graph renames Test_P.Graph.Test1_Graph;
   package Tgp1_Graph_Dyn_Dyn renames Test_P.Graph.Graph.Test1_Graph_Dyn_Dyn;
   package Tgp1_Graph_Dyn_Fix renames Test_P.Graph.Graph.Test1_Graph_Dyn_Fix;
   package Tgp1_Graph_Dyn_Exp renames Test_P.Graph.Graph.Test1_Graph_Dyn_Exp;
   package Tgp1_Graph_Fix_Dyn renames Test_P.Graph.Graph.Test1_Graph_Fix_Dyn;
   package Tgp1_Graph_Fix_Fix renames Test_P.Graph.Graph.Test1_Graph_Fix_Fix;
   package Tgp1_Graph_Fix_Exp renames Test_P.Graph.Graph.Test1_Graph_Fix_Exp;
   package Tgp1_Graph_Exp_Dyn renames Test_P.Graph.Graph.Test1_Graph_Exp_Dyn;
   package Tgp1_Graph_Exp_Fix renames Test_P.Graph.Graph.Test1_Graph_Exp_Fix;
   package Tgp1_Graph_Exp_Exp renames Test_P.Graph.Graph.Test1_Graph_Exp_Exp;
   ...
   begin
      ...
      Test_P.Graph.Verify_Contents(((1,    new IA'((2, 900), (-3, 901),
                                                   (-3, 899))),
                                    (2,    new IA'(1 => (1, 900))),
                                    (-3,   new IA'((1, 901), (1, 899))),
                                    (3,    null)),
                                   I1.all,
                                   I2.all,
                                   H1.all);

      -- Deleting the first duplicate link (#901)
      Search(I1.all, 1);
      Search(I2.all, -3);
      ...
      Test_P.Graph.Verify_Delete_List((899, 899, 900, 900));
      if (Count /= 4) then
         raise Graph_Error;
      end if;
      ...
      Tgp1_Graph.Verify_Integrity(H1.all);
      Search(I2.all, 101);
      Tgp1_Graph.Add_Link(I1.all, I2.all, 903);
      ...
      Test_P.Graph.Verify_Contents(((101,  new IA'(1 => (108, 903))),
                                    (102,  new IA'((108, 904), (103, 905))),
                                    (103,  new IA'(1 => (102, 905))),
                                    (104,  null),
                                    (105,  null),
                                    (106,  new IA'(1 => (108, 902))),
                                    (107,  null),
                                    (108,  new IA'((106, 902), (101, 903),
                                                   (102, 904)))),
                                   I1.all,
                                   I2.all,
                                   H1.all);
      ...
      Test_P.Graph.Verify_Copied_List((903, 903, 904, 904));
      Tgp1_Graph.Verify_Integrity(H1.all);
      Tgp1_Graph.Verify_Integrity(H2.all);
...
begin
   ...
   -- Free all the data.
   Test_P.Graph.Graph.Free(H1_Dyn_Dyn_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
   Test_P.Graph.Graph.Free(H2_Dyn_Dyn_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));

   Test_P.Graph.Graph.Free(H1_Dyn_Fix_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
   Test_P.Graph.Graph.Free(H2_Dyn_Fix_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));

   Test_P.Graph.Graph.Free(H1_Dyn_Exp_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
   Test_P.Graph.Graph.Free(H2_Dyn_Exp_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));

   Test_P.Graph.Graph.Free(H1_Fix_Dyn_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
   Test_P.Graph.Graph.Free(H2_Fix_Dyn_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));

   Test_P.Graph.Graph.Free(H1_Fix_Fix_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
   Test_P.Graph.Graph.Free(H2_Fix_Fix_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));

   Test_P.Graph.Graph.Free(H1_Fix_Exp_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
   Test_P.Graph.Graph.Free(H2_Fix_Exp_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));

   Test_P.Graph.Graph.Free(H1_Exp_Dyn_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
   Test_P.Graph.Graph.Free(H2_Exp_Dyn_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));

   Test_P.Graph.Graph.Free(H1_Exp_Fix_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
   Test_P.Graph.Graph.Free(H2_Exp_Fix_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));

   Test_P.Graph.Graph.Free(H1_Exp_Exp_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
   Test_P.Graph.Graph.Free(H2_Exp_Exp_Ptr);
   Test_P.Verify_Delete_List((101, 102, 104, 105, 106, 107, 108, 109));
   Test_P.Graph.Verify_Delete_List((903, 903, 904, 904));
