...
with Asgc.Graph.Dynamic.Graph_Managed;
with Asgc.Graph.Fixed.Graph_Managed;
with Asgc.Graph.Expandable.Graph_Managed;
with Ada.Unchecked_Deallocation;

package Test_P.Graph.Graph is

   package Test1_Graph_Dyn_Dyn is new Test1_Graph_Dyn.Graph_Managed
   ...
   package Test1_Graph_Dyn_Fix is new Test1_Graph_Dyn.Graph_Managed
   ...
   package Test1_Graph_Dyn_Exp is new Test1_Graph_Dyn.Graph_Managed
   ...
   package Test1_Graph_Fix_Dyn is new Test1_Graph_Fix.Graph_Managed
   ...
   package Test1_Graph_Fix_Fix is new Test1_Graph_Fix.Graph_Managed
   ...
   package Test1_Graph_Fix_Exp is new Test1_Graph_Fix.Graph_Managed
   ...
   package Test1_Graph_Exp_Dyn is new Test1_Graph_Exp.Graph_Managed
   ...
   package Test1_Graph_Exp_Fix is new Test1_Graph_Exp.Graph_Managed
   ...
   package Test1_Graph_Exp_Exp is new Test1_Graph_Exp.Graph_Managed
