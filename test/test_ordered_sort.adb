...
with Test_P;
with Test_P.Sortable;
use type Test_P.Sortable.Test1_Sort.Object;
use type Test_P.Sortable.Test1_Sort.Iterator;

procedure Test_Ordered_Sort is
   package Tvp1 renames Test_P.Test1_Con;
   package Tvp1_Ord renames Test_P.Sortable.Test1_Sort;
   package Tvp1_Vec renames Test_P.Sortable.Test1_Vec;
   package Tvp1_Vec_Exp renames Test_P.Sortable.Test1_Vec_Exp;
   package Tvp1_Vec_Fix renames Test_P.Sortable.Test1_Vec_Fix;
   package Tvp1_Alist renames Test_P.Sortable.Test1_Alist;
   package Tvp1_Alist_Exp renames Test_P.Sortable.Test1_Alist_Exp;
   package Tvp1_Alist_Fix renames Test_P.Sortable.Test1_Alist_Fix;
   package Tvp1_Dlist renames Test_P.Sortable.Test1_Dlist;
   package Tvp1_Dlist_Exp renames Test_P.Sortable.Test1_Dlist_Exp;
   package Tvp1_Dlist_Fix renames Test_P.Sortable.Test1_Dlist_Fix;
   package Tvp1_Dlist_Dyn renames Test_P.Sortable.Test1_Dlist_Dyn;
   ...
   begin
      ...
      Tvp1.Set_Container(Tvp1.Iterator'Class(I1.all), Tvp1.Object_Class(V1));
      Test_P.Sortable.Bubble.Sort(V1);
      Tvp1_Ord.Verify_Integrity(V1.all);
      Test_P.Verify_Contents_Ordered((-3, 0, 1, 2, 9, 37, 49,
                                      50, 78, 666, 888),
                                     I1.all,
                                     V1.all);

      Tvp1.Set_Container(Tvp1.Iterator'Class(I2.all), Tvp1.Object_Class(V2));
      Test_P.Sortable.Quick.Sort(V2);
      Test_P.Verify_Contents_Ordered((-3, 0, 1, 2, 9, 37, 49,
                                      50, 78, 666, 888),
                                     I2.all,
                                     V2.all);
...
begin
   ...
   Test_P.Sortable.Free(V1_Exp_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(V2_Exp_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(V1_Fix_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(V2_Fix_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));

   Test_P.Sortable.Free(A1_Exp_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(A2_Exp_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(A1_Fix_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(A2_Fix_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));

   Test_P.Sortable.Free(D1_Exp_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(D2_Exp_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(D1_Fix_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(D2_Fix_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(D1_Dyn_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
   Test_P.Sortable.Free(D2_Dyn_Ptr);
   Test_P.Verify_Delete_List((78, 37, 888, 49, 50, 1, 666, 2, -3, 9, 0));
