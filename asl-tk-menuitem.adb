...
package body Asl.Tk.Menuitem is

   MI_Configure_ASU : ASU.Unbounded_String
     := ASU.To_Unbounded_String(" entryconfigure ");

   MI_CGet_ASU : ASU.Unbounded_String
     := ASU.To_Unbounded_String(" entrycget ");

   ------------------------------------------------------------------------
   procedure MI_Apply_Attribute (W : in out Widget'Class) is
      Rv    : C.Int;
      Index : Natural;
   ...
   begin
      ...
      MI_Apply_Attribute(W);
   end MI_Add_Attribute;
   ...
   procedure Set_Text (W    : in out Widget;
                       Name : in String) is
   begin
      W.Text := ASU.To_Unbounded_String(Name);
      MI_Add_Attribute(W, "-label", """" & Name & """");
   end Set_Text;
   ...
   begin
      MI_Add_Attribute(W, "-font", """" & ASU.To_String(Font.Name) & """");
   end Set_Font;
   ...
   function Get_Font (W : in Widget)
      ...
      Retval : Font_Attr;
   begin
      Retval.Name := Retval.Name & MI_Get_Attribute(W, "-font");
   ...
   begin
      MI_Add_Attribute(W, "-image", Asl.Tk.Image.Attribute(Image));
   end Set_Image;
